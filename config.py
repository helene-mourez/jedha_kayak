...
cities = [#"Aigues Mortes", "Aix en Provence", "Amiens", "Annecy", "Avignon",
    ...
    # "Saint-Martin-d’Oydes", "Sainte-Croix-du-Verdon", "Saintes Maries de la mer", 
    # "Sillans-la-Cascade", "St Malo", "Strasbourg", "Tarascon-sur-Ariège", 
